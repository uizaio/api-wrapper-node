...
RestClient.prototype = {
  ...
  errorHandler: function(json, callback) {
    switch (true) {
      ...
      case json.code == 400:
        return callback(this.handlerResError('BadRequestError'));
      case json.code == 401:
        return callback(this.handlerResError('UnauthorizedError'));
      case json.code == 404:
        return callback(this.handlerResError('NotFoundError'));
      case json.code == 422:
        return callback(this.handlerResError('UnprocessableError'));
      case json.code == 500:
        return callback(this.handlerResError('InternalServerError'));
      case json.code == 503:
        return callback(this.handlerResError('ServiceUnavailableError'));
      case json.code > 400 && json.code < 500:
        return callback(this.handlerResError('ClientError'));
      case json.code > 500:
        return callback(this.handlerResError('ServerError'));
    }
  },
